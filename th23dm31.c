...
/* Output file */
char MYFILE[]="/home/dell/Documents/SN/globes-3.2.17/examples/DUNE_16/MeasuringParameters/th23dm/th23dm31.dat";
...
{ 
  ...
  double theta13 = 47.7 * M_PI/180.0;
  ...
  double th23_lower = 40 * M_PI/180.0;
  double th23_upper = 50 * M_PI/180.0;
  double th23_steps = 10;
  double ldm_lower  = 2.4e-3;
  double ldm_upper  = 2.6e-3;
  double ldm_steps  = 20;
  double res;
