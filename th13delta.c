...
/* Output file */
char MYFILE[]="/home/dell/Documents/SN/globes-3.2.17/examples/DUNE_16/MeasuringParameters/delta/th13delta.dat";
...
{ 
  ...
  double theta12 = 34.5 * M_PI/180.0;
  double theta13 = 8.45 * M_PI/180.0;
  double theta23 = 45.0 * M_PI/180.0;
  double deltacp = 218.0* M_PI/180.0;
  double sdm = 7.55e-5;
  double ldm = 2.5e-3;
  ...
  double th13_lower  = 4*M_PI/180.;
  double th13_upper  = 12*M_PI/180.;
  double th13_steps  = 10;
  double delta_lower = 150*M_PI/180.;
  double delta_upper = 300*M_PI/180.;
